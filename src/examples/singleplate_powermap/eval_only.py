...
if __name__ == "__main__":
    ...
    util_example.eval_plate_example(model=model, power_data=input_data,
        title=f'Gauss Power With BCs {model.engine.e()} Epochs', save_dir=eval_dir, suff=''
    )
    ...
    offset = ( # offset to halfway between original sample points
    ...
    ''' to eval earlier model if desired '''
